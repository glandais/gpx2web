...
public class GPXBikeTimeEvalOld {
	...
	public GPXBikeTimeEvalOld(double m, double puissanceMin, double puissanceMax) {
		super();
		this.m = m;
	...
	public static void main(String[] args) {
		GPXBikeTimeEvalOld bikeTimeEval = new GPXBikeTimeEvalOld(105, 130, 160);
		for (int i = -40; i < 40; i++) {
