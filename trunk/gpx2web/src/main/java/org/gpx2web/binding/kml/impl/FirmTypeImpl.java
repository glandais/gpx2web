    ...
    implements FirmType
{
    ...
    @XmlElement(name = "FirmName", namespace = "urn:oasis:names:tc:ciq:xsdschema:xAL:2.0", type = FirmTypeImpl.FirmNameImpl.class)
    ...
    public static class FirmNameImpl
        implements FirmType.FirmName
    {
