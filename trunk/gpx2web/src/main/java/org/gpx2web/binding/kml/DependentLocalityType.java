...
public interface DependentLocalityType {
     ...
     * 
     */
    List<DependentLocalityType.DependentLocalityName> getDependentLocalityNames();
     ...
     *     
     */
    void setDependentLocalityNumber(DependentLocalityType.DependentLocalityNumber value);
     ...
     * 
     */
    public interface DependentLocalityName {
    ...
    public interface DependentLocalityNumber {
         ...
         *     
         */
        String getNameNumberOccurrence();
         ...
         *     
         */
        void setNameNumberOccurrence(String value);
