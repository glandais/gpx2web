...
@XmlSeeAlso({
    StyleTypeImpl.class,
    StyleMapTypeImpl.class
})
public abstract class AbstractStyleSelectorTypeImpl
    extends AbstractObjectTypeImpl
    implements AbstractStyleSelectorType
{
    ...
    @XmlElement(name = "AbstractStyleSelectorObjectExtensionGroup", type = AbstractObjectTypeImpl.class)
