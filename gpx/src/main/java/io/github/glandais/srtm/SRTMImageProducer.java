...
public class SRTMImageProducer {
	...
	public static void main(String[] args) throws Exception {
		SRTMImageProducer imageProducer = new SRTMImageProducer(new SRTMHelper(new SRTMGL1Provider("target/cache")), -2,
				-1.5, 47, 47.5, 1024, 0);
		...
		// SRTMImageProducer imageProducer = new SRTMImageProducer(0, 5, 40, 45, 100,
		// 0);
		imageProducer.fillWithZ();
		imageProducer.saveImage(new File("C:/tmp/map.png"));

	}

	public SRTMImageProducer(SRTMHelper srtmHelper, double minlon, double maxlon, double minlat, double maxlat,
			int maxsize, double margin) {
		super();
