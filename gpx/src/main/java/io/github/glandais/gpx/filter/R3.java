...
public record R3(double x, double y, double z) {
    ...
    public static final R3 O = new R3(0.0, 0.0, 0.0);
    public static final R3 I = new R3(1.0, 0.0, 0.0);
    public static final R3 J = new R3(0.0, 1.0, 0.0);
    public static final R3 K = new R3(0.0, 0.0, 1.0);
