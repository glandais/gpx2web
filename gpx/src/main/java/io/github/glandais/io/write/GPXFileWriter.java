...
public class GPXFileWriter {
     ...
     * @throws IOException
     */
    public void writeGpxFile(GPX gpx, File target) throws IOException {
        writeGpxFile(gpx, target, false);
    }

    public void writeGpxFile(GPX gpx, File target, boolean extensions) throws IOException {
    ...
    private void writeWaypoint(FileWriter fw, GPXWaypoint waypoint) throws IOException {
        ...
        out.append("\t<wpt lat=\"")
                .append(LAT_LON_FORMATTER.get().format(waypoint.point().getLatDeg())).append("\" ")
                .append("lon=\"").append(LAT_LON_FORMATTER.get().format(waypoint.point().getLonDeg())).append("\">\n");
        out.append("\t\t" + "<name>").append(escape(waypoint.name())).append("</name>").append("\n");
        out.append("\t</wpt>\n");
