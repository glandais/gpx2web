...
import io.github.glandais.braquet.db.Cassette;
import io.github.glandais.braquet.db.Pedalier;
...
public class BraquetComputer {
    ...
    private final List<Braquet> braquets;

    public BraquetComputer() {
        super();
        braquets = new ArrayList<>();

        List<Pedalier> pedaliersSansDoublon = new ArrayList<>();
        ...
        List<Cassette> cassettesSansDoublon = new ArrayList<>();
    ...
    public void tryBraquets(GPXPath gpxPath, Braquet braquet) throws IOException {
        ...
        for (int i = 0; i < points.size() - 1; i++) {
            ...
            double invSpeed = SmootherService.computeNewValue(i, 0.1, speed, gpxPath.getDists());
